...
update () {
    if [ -d /usr/share/zsh/core ]
        then smsg "Checking and downloading updates"; cd /usr/share/zsh/core; git pull https://github.com/FrostmonsterSP/FMZshConfig.git --verbose; smsg "Settings files downloaded"
